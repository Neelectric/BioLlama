...
tokenized_query = query_tokenizer.encode(abs_12000000, return_tensors="pt", padding=True, truncation=True)
k = 5

#embed tokenized query and search
with torch.no_grad():
    encoded = query_tokenizer(abs_12000000, truncation=True, padding=True, return_tensors="pt", max_length=512)
