...
model_to_mark = 'Llama-2-70B-chat-GPTQ'
benchmark_to_mark = "bioASQ_no_snippet"
...
for i in tqdm(range(len(prompts)//10), desc="Batch Inference"):
    ...
    # print("Performing batch inference on prompts " + str(i*10) + " to " + str((i+1)*10) + ".")
